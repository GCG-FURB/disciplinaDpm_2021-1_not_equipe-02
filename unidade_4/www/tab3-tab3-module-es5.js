  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab3-tab3-module"], {
    ...
    function IqiF(module, __webpack_exports__, __webpack_require__) {
      ...
      var Tab3Page = /*#__PURE__*/function () {
        function Tab3Page(plt, alertCtrl, LocalNotifications, strorageService) {
          var _this = this;
        ...
        _createClass(Tab3Page, [{
          key: "exibirnotificacao",
          value: function exibirnotificacao() {
            this.LocalNotifications.schedule({
              id: 1,
              text: this.verificar_doencas(),
              sound: 'file://sound.mp3',
              data: {
                secret: 'KEY_ISA_HEALTINFO'
              },
              sticky: true
            });
            this.exibido = true;
          ...
          key: "verificar_doencas",
          value: function verificar_doencas() {
            var _this2 = this;

            var string = "";
            this.strorageService.getDoencas().then(function (items) {
              _this2.items = items;
            });
            ...
            this.strorageService.getContatos().then(function (contatos) {
              _this2.contatos = contatos;
            });
            string += '\n';
            this.contatos.forEach(function (element) {
              if (string == "") {
          ...
          key: "removernotificacao",
          value: function removernotificacao() {
            this.exibido = false;
    ...
    function h1hx(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-title>\n      Notificação de aviso\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n  <ion-header collapse=\"condense\">\n    <ion-toolbar>\n      <ion-title size=\"large\">Tab 3</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-button expand=\"full\" (click)=\"exibirnotificacao()\" *ngIf=\"exibido == false\">Exibir notificação</ion-button>\n  <ion-button expand=\"full\" (click)=\"removernotificacao()\" *ngIf=\"exibido == true\">Remover notificação</ion-button>\n\n</ion-content>\n";
      /***/
    },
